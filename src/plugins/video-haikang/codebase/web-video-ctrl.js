    ...
    var t = (function() {
          ...
          F = function() {
            ...
            if (f.browser().msie)
              ...
              for (var t = navigator.mimeTypes.length, n = 0; t > n; n++)
                console.log(navigator.mimeTypes[0].type);
        ...
        (this.I_Login = function(t, r, s, o, i, a) {
          ...
          (this.I_CheckPluginVersion = function() {
            console.log(c);
            return re() ? 0 : c && c.HWP_CheckPluginUpdate(k) ? -1 : 0;
          }),
          ...
          (this.I_ChangeWndNum = function(e) {
            return isNaN(parseInt(e, 10))
              ? -1
              : (re()
                  ? c && c.JS_ArrangeWindow(e)
                  : c && c.HWP_ArrangeWindow(e),
                0);
          }),
